...
>
  ...
  <div className="match-item">
    ...
    <p><strong>Available:</strong> 100 packets</p>
    <p><strong>{t.bestMatch}:</strong> Helping Hands NGO</p>
    <p><strong>{t.required}:</strong> 90 packets</p>
    <p><strong>{t.distance}:</strong> 2.5 km</p>
    <p><strong>{t.pickup}:</strong> {t.withinAvailableTime}</p>

    <div className="match-status">
      🟢 Best Match — 90 packets
    </div>
  </div>

  <div className="match-item">
    <h4>📦 {t.remainingFood}</h4>
    <p>10 packets will remain available for the next suitable receiver.</p>
...
<div className="feature-card status-card">
  ...
  {t.currentStatus}: <strong>Matched</strong>
</p>
</div>
            </>
          ) : (
